...
# Max extent threshold for graspability:
MIN_GRASP_THRESHOLDS = np.asarray([0.02, 0.02])

# image
PIXEL_SIZE = 0.002
IMAGE_SIZE = 224
IMAGE_OBJ_CROP_SIZE = 60  # this is related to the IMAGE_SIZE and PIXEL_SIZE
IMAGE_PAD_SIZE = math.ceil(IMAGE_SIZE * math.sqrt(2) / 32) * 32  # 320 # Max size of image considering all possible rotations 
...
PUSH_DISTANCE =0.016 + PIXEL_SIZE * GRIPPER_PUSH_RADIUS_SAFE_PIXEL # 0.05  # 0.05 + PIXEL_SIZE * GRIPPER_PUSH_RADIUS_SAFE_PIXEL  # 0.074
