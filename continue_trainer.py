...
# wandb setup
number = 1
NAME = "model_corrected_big_obj_continued_" + str(number)
ID = 'DQN_next_best_simple_big_objects_corrected' + str(number+1)
...
TARGET_SAVE_CHECKPOINTS = [6000, 7000, 8000, 10000, 11000, 12000, 14000, 15000] # [50, 100, 200, 500, 1000, 2000, 3000, 4000, 5000]
...
CHECKPOINT_PATH = './V2_next_best_action/models/model_checkpoints/5000.pt'
...
wandb.config.update({
    'epochs': (end_episode - start_episode),# num_episodes,
